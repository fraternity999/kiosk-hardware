...
__int16 __stdcall sam_power_on(HANDLE icdev,unsigned char CardType);
__int16 __stdcall sam_power_down(HANDLE icdev,unsigned char CardType);
...
//__int16 __stdcall sam_reset_GuoGuang(HANDLE icdev,unsigned char CardType,__int16 *len,unsigned char *receive_data);
//__int16 __stdcall sam_protocol_GuoGuang(HANDLE icdev,unsigned char CardType,__int16 sLen, unsigned char *send_cmd, __int16 *rLen,unsigned char *receive_data);

//__int16 __stdcall sam_protocol(HANDLE icdev,__int16 sLen, unsigned char *send_cmd,unsigned char *receive_data);
__int16 __stdcall sam_reset(HANDLE icdev,unsigned char CardType,__int16 *len,unsigned char *receive_data);
__int16 __stdcall sam_protocol(HANDLE icdev,unsigned char CardType,__int16 sLen, unsigned char *send_cmd, __int16 *rLen,unsigned char *receive_data);
...
long __stdcall ICC_Reader_Application_Hex(long ReaderHandle,unsigned char ICC_Slot_No,long Lenth_of_Command_APDU,char* Command_str, char* Response_APDU);
